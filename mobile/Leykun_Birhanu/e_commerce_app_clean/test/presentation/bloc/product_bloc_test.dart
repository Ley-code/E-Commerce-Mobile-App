...
void main() {
  ...
  group('get product usecase', () {
    ...
    blocTest<ProductBloc, ProductState>(
      ...
      act: (bloc) => bloc.add(const LoadSingleProductEvent(id)),
      expect: () => [
        ProductLoading(),
  ...
  group('get all products usecase', () {
   ...
   group('add product usecase', () {
    ...
    blocTest<ProductBloc, ProductState>(
      ...
      act: (bloc) => bloc.add(const CreateProductEvent(tProductEntity)),
      expect: () => [
        ProductLoading(),
  ...
  group('update product usecase', () {
    ...
    blocTest<ProductBloc, ProductState>(
      ...
      act: (bloc) => bloc.add(const UpdateProductEvent(tProductEntity)),
      expect: () => [
        ProductLoading(),
  ...
  group('delete product usecase', () {
    ...
    blocTest<ProductBloc, ProductState>(
      ...
      act: (bloc) => bloc.add(const DeleteProductEvent(id)),
      expect: () => [
        ProductLoading(),
